...
const endpointUrl: string = process.env.B2_ENDPOINT_URL as string;
const region: string = process.env.B2_REGION || 'us-east-005';
const accessKeyId: string = process.env.B2_ACCESS_KEY_ID as string;
const secretAccessKey: string = process.env.B2_SECRET_ACCESS_KEY as string;
...
const fullEndpoint: string = endpointUrl.startsWith('http') ? endpointUrl : `https://${endpointUrl}`;
...
export const B2_BUCKET_NAME: string = process.env.B2_BUCKET_NAME as string;
